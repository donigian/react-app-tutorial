...
Please install the React Developer Tools chrome plugin. 
Once installed, open the plugin using (cmd+option+i) and use it to explore components in your app like the screenshot below

![Screenshot](./assets/notebook_render_v1.png)
